...
namespace projektGame.Game
{
    public partial class InGame4 : Form
    {
        ...
        public InGame4(gamecontroller gct0, int layout = 0)
        {
            InitializeComponent();
        ...
        private void InGame4_Load(object sender, EventArgs e)
        {
            gct.lvl = 4;
            gct.lvlBack = 4;
        ...
        private void tmMain_Tick(object sender, EventArgs e)
        {
            ...
            foreach (Control picture in this.Controls)
            {
                ...
                if (picture is PictureBox && picture.Tag == "action")
                {
                    ...
                    if (makeaction == true && chestopen == false && ((PictureBox)picture).Bounds.IntersectsWith(Link.Bounds))
                    {
                        ...
                        pbchest_closed_1.Left = 128; 
                        pbchest_closed_1.Top = 192;
                    }
                }
            ...
            #region LevelUp
            if (pbToLvl2f4.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 2;
                gct.lvlBack = 4;
                gct.load0 = false;
            ...
            if (pbToLvl5f4.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 5;
                gct.lvlBack = 4;
                gct.load0 = false;
            ...
            if (pbToLvl6f4.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 6;
                gct.lvlBack = 4;
                gct.load0 = false;
        ...
        private void btInGame4Menu_Click(object sender, EventArgs e)
        {
            gct.showMenu();         
            gct.hideInGame4();
        }
