...
{
    public partial class InGame7 : Form
    {
        ...
        public InGame7(gamecontroller gct0, int layout = 0)
        {
            InitializeComponent();
        ...
        private void InGame7_Load(object sender, EventArgs e)
        {
            gct.lvl = 7;
            gct.lvlBack = 7;
        ...
        private void tmMain_Tick(object sender, EventArgs e)
        {
            ...
            if (pbToLvl6f7.Bounds.IntersectsWith(Link.Bounds))
            {
            ...
            if (pbToLvl51f7.Bounds.IntersectsWith(Link.Bounds))
            {
                //Variablen werden angepasst
                gct.lvl = 51;
                gct.lvlBack = 7;
        ...
        private void btInGame7Menu_Click(object sender, EventArgs e)
        {
            gct.showMenu();
            gct.ingame7.Hide();
        }
