...
{
    public partial class InGame51 : Form
    {
        #region variables
        ...
        public InGame51(gamecontroller gct0, int layout = 0)
        {
            InitializeComponent();
        ...
        private void InGame51_Load(object sender, EventArgs e)
        {
            gct.lvl = 51;
            gct.lvlBack = 51;
        ...
        private void tmMain_Tick(object sender, EventArgs e)
        {
            ...
            if (pbToLvl5f51.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 5;
                gct.lvlBack = 51;
                gct.load0 = false;
            ...
            if (pbToLvl7f51.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 7;
                gct.lvlBack = 51;
                gct.load0 = false;
        ...
        private void btInGame51Menu_Click_1(object sender, EventArgs e)
        {
            gct.showMenu();
            gct.ingame51.Hide();
        }
