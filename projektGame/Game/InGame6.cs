...
{
    public partial class InGame6 : Form
    {
        ...
        public InGame6(gamecontroller gct0, int layout = 0)
        {
            InitializeComponent();
        ...
        private void InGame6_Load(object sender, EventArgs e)
        {
            gct.lvl = 6;
        ...
        private void tmMain_Tick(object sender, EventArgs e)
        {
            ...
            foreach (Control picture in this.Controls)
            {
                ...
                if (picture is PictureBox && picture.Tag == "action")
                {
                    ...
                    if (makeaction == true && chestopen == false && ((PictureBox)picture).Bounds.IntersectsWith(Link.Bounds))
                    {
                        ...
                        pbchest_closed_1.Left = 792; 
                        pbchest_closed_1.Top = 400;
                    }
                }
            ...
            #region LevelUp
            if (pbToLvl4f6.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 4;
                gct.lvlBack = 6;
                gct.load0 = false;
            ...
            if (pbToLvl7f6.Bounds.IntersectsWith(Link.Bounds))
            {
                gct.lvl = 7;
                gct.lvlBack = 6;
                gct.load0 = false;
        ...
        private void btInGame6Menu_Click(object sender, EventArgs e)
        {
            gct.showMenu();
            gct.hideInGame6();
        }
